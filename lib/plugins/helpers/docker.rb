...
class Plugin
  ...
  #   case lang
  #   when 'ruby', 'rb'
  #     { file_type: '.rb', image: 'slapi/ruby', tag:'latest' }
  #   when 'python', 'py'
  #     { file_type: '.py', image: 'slapi/python', tag:'latest' }
  #   when 'node', 'nodejs', 'javascript', 'js'
  #     { file_type: '.js', image: 'slapi/nodejs', tag:'latest' }
  #   when 'bash', 'shell', 'sh'
  #     { file_type: '.sh', image: 'slapi/base', tag:'latest' }
  #   else
